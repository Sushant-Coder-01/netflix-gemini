...
const GptSearchWelcome = () => {
  ...
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center h-screen bg-black/20 text-white px-4 ">
      <div className="relative z-10 text-center space-y-6">
        ...
        <div className="mt-8 space-y-3 text-center text-gray-400">
          <p>{lang[langKey].prompt}</p>
          <p>{lang[langKey].genres_example}</p>
        </div>
      </div>
    </div>
  );
